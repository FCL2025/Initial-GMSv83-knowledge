...
| 章節 | 內容 |
|------|------|
| [00-學習地圖](./obsidian_vault/MapleStory-v83/00-學習地圖/) | 學習路徑與里程碑 |
| [01-基礎知識](./obsidian_vault/MapleStory-v83/01-基礎知識/) | 架構、WZ 檔案、術語 |
| [02-客戶端修改](./obsidian_vault/MapleStory-v83/02-客戶端修改/) | Hex、WZ 編輯、脫殼 |
| [03-伺服器開發](./obsidian_vault/MapleStory-v83/03-伺服器開發/) | Java、MySQL、架設 |
| [04-進階主題](./obsidian_vault/MapleStory-v83/04-進階主題/) | 抓包、Opcode、腳本 |
| [05-工具資源](./obsidian_vault/MapleStory-v83/05-工具資源/) | 工具清單與下載 |
...
```bash
# 克隆倉庫
git clone https://github.com/FCL2025/Initial-GMSv83-knowledge.git

# 用 Obsidian 開啟筆記
# 下載 Obsidian: https://obsidian.md/
# 開啟 obsidian_vault/MapleStory-v83 作為 Vault
```
